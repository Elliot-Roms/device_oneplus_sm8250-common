...
import org.evolution.device.DeviceSettings.ModeSwitch.*;
import org.evolution.device.DeviceSettings.Preference.CustomSeekBarPreference;
import org.evolution.device.DeviceSettings.Preference.SwitchPreference;
import org.evolution.device.DeviceSettings.Preference.VibratorStrengthPreference;
import org.evolution.device.DeviceSettings.Services.VolumeService;
import org.evolution.device.DeviceSettings.Services.FPSInfoService;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
          if (preference == mMuteMedia) {
            ...
            Intent hbmIntent = new Intent(this.getContext(),
                    org.evolution.device.DeviceSettings.Services.HBMModeService.class);
            if (enabled) {
