...
public class FPSTileService extends TileService {
  ...
  public void onStartListening() {
      ...
      for (ActivityManager.RunningServiceInfo service :
          ...
          if (org.evolution.device.DeviceSettings.Services.FPSInfoService.class.getName().equals(
  ...
  @Override
  public void onClick() {
      Intent fpsinfo = new Intent(this, org.evolution.device.DeviceSettings.Services.FPSInfoService.class);
      if (!isShowing)
